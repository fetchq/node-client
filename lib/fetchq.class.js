...
class Fetchq {
  constructor(settings = {}) {
    // Create a shallo copy of the settings,
  ...
  async start() {
    // TODO: poll the db for `SELECT * FROM fetchq_info();`
    //       so to be sure that the Fetchq instance was correctly initialized
    //       and that it works accordingly with the local version
    //       of Fetchq
